...
AS $$
DECLARE
  project_url TEXT := 'https://ignawphhjhzvmnflutke.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlnbmF3cGhoamh6dm1uZmx1dGtlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMjA2NTExMiwiZXhwIjoyMDI3NjQxMTEyfQ.UWgsL7MYift_29tFLXxZsTGVQFWm8qwVpI_36Med2P0'; -- full access needed for http request to storage
